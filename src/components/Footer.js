        ...
        <div className="container-fluid corFooter">
            <footer className="text-center text-lg-start py-5">
                ...
                <div className="container">
                    {/* Linha principal: Alinha itens no topo e garante que o conteúdo não exceda a largura. */}
                    <div className="row d-flex align-items-start"> 
                        
                        {/* 1. COLUNA ESQUERDA: REDES SOCIAIS */}
                        {/* Centralizado no mobile, alinhado à esquerda no desktop */}
                        <div className="col-lg-4 col-md-12 mb-4 mb-lg-0 text-white text-center text-lg-start">
                            <h5 className="mb-3 fs-4">Siga-nos</h5>
                            {/* Container dos botões: centralizado no mobile, à esquerda no desktop */}
                        ...
                        <div className="col-lg-4 col-md-12 mb-4 mb-lg-0 text-center text-white d-flex flex-column justify-content-center align-items-center">
                        ...
                        {/* Centralizado no mobile, alinhado à direita no desktop */}
                        <div className="col-lg-4 col-md-12 text-center text-lg-end"> 
                            
                            <h5 className="mb-3 text-white fs-4">Nossa Localização</h5>
                             
                            {/* Container do mapa: Alinha à direita no desktop e centraliza no mobile. */}
                            <div className="d-flex justify-content-center justify-content-lg-end"> 
                                <div className="shadow-lg rounded" style={{maxWidth: '300px'}}>
                                    <iframe 
                                        src={mapIframeSrc} 
                                        width="100%" 
                                        height="150" 
